...
public class DataGenerator implements CommandLineRunner {
    ...
    public DataGenerator(MerchantRepository merchantRepository, PaymentRepository paymentRepository, CustomerRepository customerRepository, ItemRepository itemRepository, CartRepository cartRepository) {
    ...
    public void run(String... args) throws Exception {
        ...
        Customer customer1=new Customer("Texas", "ayb@gmail.com","Andy", "Hudson","aybolek27");
